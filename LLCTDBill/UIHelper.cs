...
namespace LLCTDBill
{
    ...
    class UIHelper : TestBase
    {
        ...
        //public static bool ElementIsPresent(By elementLocator)
        //{
        //    //Need to decrease implicit wait to work
        //    if (driver.FindElements(elementLocator).Count > 0)
        //    {
        //        return true;
        //    }
        //    else
        ...
        public static bool ElementIsPresent(string elementLocator)
        {
            if (driver.PageSource.Contains(elementLocator))
            {
                return true;
            }
            else
        ...
        public static void SelectRandomComboElement(IWebElement ddl, string option)
        {
            ClickOnLink(ddl);
        ...
        public static bool SearchGridAndVerify(IWebDriver driver, IWebElement Table, String verify, int columnNumber)
        {
            ...
            else
            {
                for (int i = 1; i < itemCount;)
                {
                    ...
                    {
                        flag = 1;
                        IWebElement linkElement = Columns[0].FindElement(By.TagName("a"));
        ...
        public static void SendEmailonError(string FromEmail, string ToEmail, string Subject, string Body)
        {
            ...
            SmtpServer.Port = 587;
            //SmtpServer.Port = 465;
            SmtpServer.Credentials = new System.Net.NetworkCredential(FromEmail, "Itmagnet-03");
            SmtpServer.EnableSsl = true;
