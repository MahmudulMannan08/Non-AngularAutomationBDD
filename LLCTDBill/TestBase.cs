namespace LLCTDBill
{
    ...
    {
        public static string LawyerPortal = null;
        public static string LawyerUsername = null;
        public static string LenderUsername = null;
        public static string LawyerPassword = null;
        public static string LawyerIDNo = null;
        public static string LenderIdNo = null;
        public static string TDEndPoint = null;
        public static string DocumentType = null;
        public static string DocumentType_ON = null;
        public static string TotalLoanAmount = null;
        public static string CreditAgrInfo = null;
        public static string LoanAmount = null;
        public static string CreditAgrName = null;
        public static string CreditAgrDate = null;
        public static string MsgSaveSuccess = null;
        public static string CreditAgrNameVal = null;
        public static string CreditAgreementFormName = null;
        public static string CreditAgreementDate = null;
        public static string UpdateCreditAgrDate = null;
        public static string CreditAgreementFormNumberUpdate = null;
        public static string CreditAgreementFormNameUpdate = null;
        public static string CreditAgreementDateUpdate = null;
        public static string TotalLoanAmountUpdate = null;
        public static string ActivityLenderAmendment = null;
        public static string ClosingDateUpdate = null;
        public static string ActivityClosingDateAmendment = null;
        public static string OutlookURL = null;
        public static string OutlookUsername = null;
        public static string OutlookPassword = null;
        ...
        {
            StreamReader jsonFile = new StreamReader(projectDirectory + @"\LLCTDBill\LLCTDBill\RunSettings.json");
            ...
            LawyerPortal = jsonContent["Settings"]["LawyerDetails"][Env]["LawyerPortal"].ToString();
            LawyerUsername = jsonContent["Settings"]["LawyerDetails"][Env]["LawyerUsername"].ToString();
            LawyerPassword = jsonContent["Settings"]["LawyerDetails"][Env]["LawyerPassword"].ToString();
            LawyerIDNo = jsonContent["Settings"]["LawyerDetails"][Env]["LawyerIDNo"].ToString();
            LenderIdNo = jsonContent["Settings"]["LenderDetails"][Env]["LenderIdNo"].ToString();
            LenderUsername = jsonContent["Settings"]["LenderDetails"][Env]["LenderUsername"].ToString();
            TDEndPoint = jsonContent["Settings"]["TD"][Env]["TDEndPoint"].ToString();
            OutlookURL = jsonContent["Settings"]["OutlookDetails"]["OutlookURL"].ToString();
            OutlookUsername = jsonContent["Settings"]["OutlookDetails"]["OutlookUsername"].ToString();
            OutlookPassword = jsonContent["Settings"]["OutlookDetails"]["OutlookPassword"].ToString();
        }

        public static void TDTestData()
        {
            StreamReader jsonFile = new StreamReader(projectDirectory + @"\LLCTDBill\LLCTDBill\TestData\TDTestData.json");
            string json = jsonFile.ReadToEnd();
            var jsonContent = JObject.Parse(json);
            var Lang = jsonContent["Data"]["Language"].ToString();
            DocumentType = jsonContent["Data"]["Service"][Lang]["DocumentType"].ToString();
            DocumentType_ON = jsonContent["Data"]["Service"][Lang]["DocumentType_ON"].ToString();
            TotalLoanAmount = jsonContent["Data"]["Service"][Lang]["TotalLoanAmount"].ToString();
            CreditAgrNameVal = jsonContent["Data"]["DealDetails"][Lang]["txtCreditAgrName"].ToString();
            CreditAgreementFormName = jsonContent["Data"]["Service"][Lang]["CreditAgreementFormName"].ToString();
            CreditAgreementDate = CurrentOrFutureDate("yyyy-MM-dd");
            UpdateCreditAgrDate = jsonContent["Data"]["DealDetails"][Lang]["UpdateCreditAgrDate"].ToString();
            CreditAgreementFormNumberUpdate = jsonContent["Data"]["Service"][Lang]["CreditAgreementFormNumberUpdate"].ToString();
            CreditAgreementFormNameUpdate = jsonContent["Data"]["Service"][Lang]["CreditAgreementFormNameUpdate"].ToString();
            CreditAgreementDateUpdate = jsonContent["Data"]["Service"][Lang]["CreditAgreementDateUpdate"].ToString();
            TotalLoanAmountUpdate = jsonContent["Data"]["Service"][Lang]["TotalLoanAmountUpdate"].ToString();
            ClosingDateUpdate = jsonContent["Data"]["Service"][Lang]["ClosingDateUpdate"].ToString();
        }

        public static void TestData()
        {
            StreamReader jsonFile = new StreamReader(projectDirectory + @"\LLCTDBill\LLCTDBill\TestData\TestData.json");
            string json = jsonFile.ReadToEnd();
            var jsonContent = JObject.Parse(json);
            var Lang = jsonContent["Data"]["Language"].ToString();
            CreditAgrInfo = jsonContent["Data"]["DealDetails"][Lang]["lblCreditAgrInfo"].ToString();
            LoanAmount = jsonContent["Data"]["DealDetails"][Lang]["lblLoanAmount"].ToString();
            CreditAgrName = jsonContent["Data"]["DealDetails"][Lang]["lblCreditAgrName"].ToString();
            CreditAgrDate = jsonContent["Data"]["DealDetails"][Lang]["lblCreditAgrDate"].ToString();
            MsgSaveSuccess = jsonContent["Data"]["Messages"][Lang]["MsgSaveSuccess"].ToString();
            ActivityLenderAmendment = jsonContent["Data"]["DealHistory"][Lang]["ActivityLenderAmendment"].ToString();
            ActivityClosingDateAmendment = jsonContent["Data"]["DealHistory"][Lang]["ActivityClosingDateAmendment"].ToString();
        }
        ...
        public static string ConvertXML2Json(string XmlFilePath)
        {
        ...
        {
            string textContents = File.ReadAllText(TxtFilePath);
            return textContents;
        }
        ...
        //public static IWebDriver StartBrowser(string browser)
        {
            ...
            ngdriver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(40);
